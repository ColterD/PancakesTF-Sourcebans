<?php /* Smarty version 2.6.29, created on 2017-10-19 19:55:18
...
<?php if ($this->_tpl_vars['IN_SERVERS_PAGE'] && $this->_tpl_vars['access_bans']): ?><div style="text-align:right; width:100%;"><small>Hint: Rightclick on a player to open a context menu with options to kick, ban or contact the player directly.</small></div><?php endif; ?>
			...
			<thead>
			  <tr>
				<td width="2%" height="16" class="listtable_top" align="center">MOD</td>
				<td width="2%" height="16" class="listtable_top" align="center">OS</td>
				<td width="2%" height="16" class="listtable_top" align="center">VAC</td>
				<td height="16" class="listtable_top" align="center"><b>Hostname</b></td>
				<td width="10%" height="16" class="listtable_top" align="center"><b>Players</b></td>
				<td width="10%" height="16" class="listtable_top" align="center"><b>Map</b></td>
			  </tr>
			 </thead>
			 <tbody>
...
"><i>Querying Server Data...</i></td>
		            <td height="16" class="listtable_1" align="center" id="players_<?php echo $this->_tpl_vars['server']['sid']; ?>
">N/A</td>
