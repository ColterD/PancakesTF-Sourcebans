...
<div class="front-module" style="width:100%">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr height="16">
			<td width="16" class="listtable_top" align="center">GAME</td>
			...
			<td width="14%" class="listtable_top" align="center"><strong>Length</strong></td>
		</tr>
      ...
      <td class="listtable_1" align="center"><img src="images/games/{$player.icon}" width="16" alt="GAME" title="GAME" /></td>
...
<div class="front-module" style="float:right;width:49%">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr>
			<td width="16px" height="16" class="listtable_top" align="center">Type</td>
			<td height="25%" class="listtable_top" align="center"><b>Date/Time</b></td>
			<td height="16" class="listtable_top" align="center"><b>Name</b></td>	  
		</tr>
...
<div class="front-module" style="float:left;width:49%">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr height="16">
			...
			<td width="24%" class="listtable_top" align="center"><strong>Date/Time</strong></td>
			<td class="listtable_top" align="center"><strong>Name</strong></td>
			<td width="23%" class="listtable_top" align="center"><strong>Length</strong></td>
		</tr>
		{foreach from=$players_commed item=player}
		<tr onclick="{$player.link_url}" onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" style="cursor:pointer;" height="16">
      <td class="listtable_1" align="center"><img src="{$player.type}" width="16" alt="GAME" title="GAME" /></td>
