...
img[src="images/games/tf2.png"] {
  content: url('https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Team_Fortress_2_style_logo.svg/2000px-Team_Fortress_2_style_logo.svg.png');
  height: 16px;
}
/* End Custom Stuff */
...
@font-face {
 ...
 /*
#banlist #banlist-nav,
#banlist #banlist-nav a,
#banlist > a,
#breadcrumb,
#breadcrumb a,
#content > #banlist-nav,
#content > #banlist-nav a,
.banlist-nav a,
.front-module-header:not(td),
.front-module-intro,
small,
div.rowdesc {
	color: rgba(255, 255, 255, 0.5);
}
#admin-page-content .front-module-header:not(td) {
#admin-page-content .rowdesc,
	color: #444444;
}
*/
 
 .front-module-line small {
     color: #FFFFFF;
 }
 .contextmenu b.head {
 ...
 tr td.listtable_1[style],
 tr td.listtable_top[style],
 tr.tbl_out td[style],
 tr[id^='sid_'] td[style],
 tr[id^='sid_'] .listtable_1 {
     /* border-color: #333 !important; */
 ...
 .tablerow2 {
     background-color: #B8383B !important;
     border-color: #242526 !important;
 }
 div.contextmenu {
     background-color: #333 !important;
 ...
 .inputbox {
     ...
     width: 105px;
     font-size: 14px;
     background-color: #242526 width: 200px;
     padding-left: 2px;
 }
 .dbg.b {
     font-size: 12px;
 ...
 #mainwrapper {
     ...
     /*centers the box, no matter the overall width */
...
.btn{
 ...
 .msgbox-border {
     ...
     overflow: hidden;
     top: 250px;
     background: url(../images/msg-bubble.png) no-repeat center;
     padding: 15px;
     margin: auto 210px;
     width: 520px;
 }
...
#cpanel ul li.active {} #cpanel ul li img {
    margin-top: 13px;
}
/* Admin Page Menu */
